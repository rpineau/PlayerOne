...
cp ~/src/Astro/PlayerOne_Camera_SDK/PlayerOne_Camera_SDK_Linux_V${SDK_VERSION}/static_lib/x64/libPlayerOneCamera_Static.a static_libs/x86_64/

cp ~/src/Astro/PlayerOne_Camera_SDK/PlayerOne_Camera_SDK_Linux_V${SDK_VERSION}/static_lib/arm32/libPlayerOneCamera_Static.a static_libs/armv7l/

cp ~/src/Astro/PlayerOne_Camera_SDK/PlayerOne_Camera_SDK_Linux_V${SDK_VERSION}/static_lib/arm64/libPlayerOneCamera_Static.a static_libs/aarch64/
